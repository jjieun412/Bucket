...
public class EditBucketResponse2 {
    ...
    public EditBucketResponse2(JsonObject obj)
    {
        this.status = obj.get("status").toString();
        this.msg = obj.get("msg").toString();
        Log.d("message", "runtime type: " + obj.get("bucketList").getClass().toString());
    ...
    public class bucketList {
        ...
        public JsonArray getDetailplans() { return detailplans; }
        public void setDetailplans(JsonArray detailplans) { this.detailplans = detailplans; }
