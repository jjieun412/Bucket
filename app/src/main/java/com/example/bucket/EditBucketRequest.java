...
public class EditBucketRequest {
    ...
    public String toString() { return startDate + " " + endDate + " " + title + " " + content + " " + isVisible + " " + detailplans + " " + tags + " " + picture + " " + bucketId; }


    public EditBucketRequest(String token, String startDate, String endDate, String title, String content, Integer isVisible, List<String> detailplans, MultipartBody.Part picture, List<String> tags, Integer bucketId) {
        this.token = token;
