...
public class BKListItemView_my extends LinearLayout {
    ImageView picture;
    TextView list_title;
    ...
    public BKListItemView_my(Context context, bucketList_my bk) {
        super(context);
        this.bk = bk;
        init(context);
    }

    public BKListItemView_my(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }
    ...
    public void init(Context context){
        ...
        inflater.inflate(R.layout.mybklist_add, this, true);
        ...
        picture.setOnClickListener(v -> {
            System.out.println("getting details of bucket " + bk.getBucketId());

            BK_ID = bk.getBucketId();
            Intent intent = new Intent(context, MyBKListDetailActivity.class);
